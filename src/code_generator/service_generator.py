...
def list_{self._database_model.model_name_snake_case}s():
    return {self.repo_file}.list_{self._database_model.model_name_snake_case}s()\n\n"""
...
def get_{self._database_model.model_name_snake_case}({primary_key[0]}):
    return {self.repo_file}.get_{self._database_model.model_name_snake_case}({primary_key[0]})\n\n"""
...
def create_{self._database_model.model_name_snake_case}({", ".join(attributes)}):
    return {self.repo_file}.create_{self._database_model.model_name_snake_case}({", ".join(attributes)})\n\n"""
...
def update_{self._database_model.model_name_snake_case}({self._database_model.model_primary_keys[0][0]}, {"=None, ".join(attributes[1:])}=None):
    return {self.repo_file}.update_{self._database_model.model_name_snake_case}({", ".join(attributes)})\n\n"""
...
def delete_{self._database_model.model_name_snake_case}({self._database_model.model_primary_keys[0][0]}):
     return {self.repo_file}.delete_{self._database_model.model_name_snake_case}({self._database_model.model_primary_keys[0][0]})\n\n"""
